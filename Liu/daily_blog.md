...
(see https://github.com/pfnet/chainer#installation).
  'cuDNN is not enabled.\n'
Traceback (most recent call last):
  File "experiment_alex_cifar10.py", line 44, in <module>
    num_epoch=TRAIN_NUM_EPOCHS)
  File "/home/cc/branchynet/branchynet/utils.py", line 246, in train
    losses,accuracies = branchyNet.train_main(x,t)
  File "/home/cc/branchynet/branchynet/net.py", line 383, in train_main
  ...
  File "/home/cc/anaconda3/envs/branchnet/lib/python2.7/site-packages/cupy/cuda/compiler.py", line 56, in _run_nvcc
    raise RuntimeError(msg)
RuntimeError: `nvcc` command returns non-zero exit status.
command: ['nvcc', '--cubin', '-arch', 'sm_75', '/tmp/tmpjmx8IT/kern.cu']
return-code: 1
stdout/stderr:
/tmp/tmpjmx8IT/kern.cu(14): error: identifier "__float2half_rn" is undefined

/tmp/tmpjmx8IT/kern.cu(17): error: identifier "__float2half_rn" is undefined

/tmp/tmpjmx8IT/kern.cu(20): error: identifier "__float2half_rn" is undefined

/tmp/tmpjmx8IT/kern.cu(23): error: identifier "__float2half_rn" is undefined

/tmp/tmpjmx8IT/kern.cu(26): error: identifier "__float2half_rn" is undefined

/tmp/tmpjmx8IT/kern.cu(29): error: identifier "__float2half_rn" is undefined

/tmp/tmpjmx8IT/kern.cu(32): error: identifier "__float2half_rn" is undefined

/tmp/tmpjmx8IT/kern.cu(35): error: identifier "__half2float" is undefined

8 errors detected in the compilation of "/tmp/tmpxft_0000469c_00000000-6_kern.cpp1.ii".
...
(see https://github.com/pfnet/chainer#installation).
  'cuDNN is not enabled.\n'
Traceback (most recent call last):
  File "experiment_resnet_cifar10.py", line 44, in <module>
    num_epoch=TRAIN_NUM_EPOCHS)
  File "/home/cc/branchynet/branchynet/utils.py", line 246, in train
    losses,accuracies = branchyNet.train_main(x,t)
  File "/home/cc/branchynet/branchynet/net.py", line 383, in train_main
  ...
  File "/home/cc/anaconda3/envs/branchnet/lib/python2.7/site-packages/cupy/cuda/compiler.py", line 56, in _run_nvcc
    raise RuntimeError(msg)
RuntimeError: `nvcc` command returns non-zero exit status.
command: ['nvcc', '--cubin', '-arch', 'sm_75', '/tmp/tmphP4Q1g/kern.cu']
return-code: 1
stdout/stderr:
/tmp/tmphP4Q1g/kern.cu(14): error: identifier "__float2half_rn" is undefined

/tmp/tmphP4Q1g/kern.cu(17): error: identifier "__float2half_rn" is undefined

/tmp/tmphP4Q1g/kern.cu(20): error: identifier "__float2half_rn" is undefined

/tmp/tmphP4Q1g/kern.cu(23): error: identifier "__float2half_rn" is undefined

/tmp/tmphP4Q1g/kern.cu(26): error: identifier "__float2half_rn" is undefined

/tmp/tmphP4Q1g/kern.cu(29): error: identifier "__float2half_rn" is undefined

/tmp/tmphP4Q1g/kern.cu(32): error: identifier "__float2half_rn" is undefined

/tmp/tmphP4Q1g/kern.cu(35): error: identifier "__half2float" is undefined

8 errors detected in the compilation of "/tmp/tmpxft_00004715_00000000-6_kern.cpp1.ii".
```